...
STRUCTURED_EXTRACT_INSTRUCTION = (
    ...
    '- "detailed_summary": object with keys "publication_identity", "issue_thesis", "sections" (array of objects like {{"heading": "...", "bullets": ["..."]}}), "conclusions_or_recommendations" (array), "stance" (enum optimistic|skeptical|cautionary|neutral|mixed), "cta" (string OR null)\n\n'

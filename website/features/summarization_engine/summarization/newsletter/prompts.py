...
STRUCTURED_EXTRACT_INSTRUCTION = (
    ...
    "TONE CONSTRAINTS (newsletter):\n"
    "- Use only neutral reporting verbs: states, describes, lists, reports, "
    "explains, summarizes, links to, presents, includes.\n"
    "- Do NOT use evaluative adjectives: groundbreaking, innovative, "
    "significant, novel, impressive, challenging, advanced, cutting-edge, "
    "remarkable, robust.\n"
    "- Do NOT infer audience, purpose, or significance (\"aimed at X\", "
    "\"advancements in Y\").\n"
    "- Every numeral, code, identifier, or proper-noun token must appear "
    "verbatim in the source. If unsure, omit.\n\n"

...
## Phase B — True-source evidence reference (Sol 1)  ✅ EXPANDED (with A5) → `docs/superpowers/plans/2026-06-12-wave0-eval-evidence-and-contract.md`
...
## Wave 1A — Reddit deterministic consensus templates (Sol 4)  [highest faithfulness leverage, cheap]  → ✅ EXPANDED: `docs/superpowers/plans/2026-06-12-wave1a-reddit-coverage.md`
...
## Wave 1B — YouTube speaker-gate + idempotent formatter + format-verb (Sol 5)  → ✅ EXPANDED: `docs/superpowers/plans/2026-06-12-wave1b-youtube-speaker-idempotent.md`
...
## Wave 2 — GitHub interface evidence-ladder (Sol 3)  → ✅ EXPANDED: `docs/superpowers/plans/2026-06-12-wave2-github-interface-ladder.md`

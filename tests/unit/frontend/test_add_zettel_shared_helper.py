...
def test_add_zettel_pages_reference_fresh_surface_scripts():
    pages_to_scripts = {
        ...
        / "features"
        / "user_home"
        / "index.html": "/home/js/home.js?v=20260523a",
        ROOT
        / "website"
        / "features"
        / "user_zettels"
    ...
    assert "/home/css/home.css?v=20260523c" in (
        ROOT / "website" / "features" / "user_home" / "index.html"
    ).read_text(encoding="utf-8")
    assert "/home/js/home.js?v=20260523a" in (
        ROOT / "website" / "features" / "user_home" / "index.html"
    ).read_text(encoding="utf-8")
    assert "/home/zettels/css/user_zettels.css?v=20260523c" in (
        ROOT / "website" / "features" / "user_zettels" / "index.html"
    ).read_text(encoding="utf-8")
...
def test_summary_css_cachebusted():
    ...
    expected_css = {
        "website/features/user_home/index.html": "home.css?v=20260523c",
        "website/features/user_zettels/index.html": "user_zettels.css?v=20260523c",
    }

...
def test_add_zettel_pages_reference_fresh_surface_scripts():
    ...
    assert "/home/css/home.css?v=20260523f" in (
        ROOT / "website" / "features" / "user_home" / "index.html"
    ).read_text(encoding="utf-8")
    assert "/home/js/home.js?v=20260523f" in (
        ROOT / "website" / "features" / "user_home" / "index.html"
    ).read_text(encoding="utf-8")
    assert "/home/zettels/css/user_zettels.css?v=20260523f" in (
        ROOT / "website" / "features" / "user_zettels" / "index.html"
    ).read_text(encoding="utf-8")
...
def test_summary_css_cachebusted():
    ...
    expected_css = {
        "website/features/user_home/index.html": "home.css?v=20260523f",
        "website/features/user_zettels/index.html": "user_zettels.css?v=20260523f",
    }
